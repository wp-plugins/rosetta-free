jQuery(document).ready(function($) {
        ...
        if(post_langs != null){
            _post_langs = $.parseJSON(post_langs);
        }
...
jQuery.fn.add_language_fields = function() {
    ...
    for(i = 1; i < _post_langs['langs'].length; i++){
        ...
        item.attr('id', 'rosetta-'+item.attr('id')+'-'+_post_langs['langs'][i][0]).attr('name', 'rosetta-menu-item-title[' + _post_langs['langs'][i][0] + '][' + menu_item_id + ']');
