<?php
if( ! class_exists('Force_Secondary_Hosts_Login') ){
	...
	function __construct() {
		...
		add_action( 'rosetta_parameters', array( $this, 'get_localize_params' ), null, 3 );
		add_action( 'init', array( $this, 'set_user_cookie' ) );
		add_filter( 'rosetta_get_permalink', array( $this, 'get_permalink' ), 1, 1 );
		//add_filter( 'rosetta_get_permalink', array( $this, 'get_permalink' ), 1, 1 );
	...
	$hosts_login = new Force_Secondary_Hosts_Login();
}
?>
